...
parser.add_argument('--num_gpus', type=int, default=2, help='GPU to use [default: GPU 0]')
parser.add_argument('--model', default='dgs_sem_seg', help='Model name [default: model]')
parser.add_argument('--log_dir', default='log', help='Log dir [default: log]')
parser.add_argument('--num_point', type=int, default=8192, help='Point Number [default: 8192]')
parser.add_argument('--max_epoch', type=int, default=1001, help='Epoch to run [default: 201]')
            ...
            for i in range(NUM_GPUS): 
                with tf.variable_scope(tf.get_variable_scope(), reuse=True): 
                    ...
                    with tf.device('/gpu:%d'%(i)), tf.name_scope('gpu_%d'%(i)) as scope:
                        ...
                        loss = MODEL.get_loss(pred, label_batch, smpws_pl_batch)
...
def train_one_epoch(sess, ops, train_writer):
    ...
    total_seen = 0
    loss_sum = 0
    print("The # of param is: ", get_num_params())
